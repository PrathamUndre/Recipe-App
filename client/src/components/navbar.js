      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto text-center">
            ...
            <li className="nav-item">
              <Link to="/create-recipe" className="nav-link" onClick={closeNavbar}>📝 Create Recipe</Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item mt-2 mt-lg-0">
              {!cookies.access_token ? (
                <Link to="/auth" className="btn btn-outline-light fw-bold px-4 w-100" onClick={closeNavbar}>
                  🔑 Login
                </Link>
              ) : (
                <button
                  onClick={() => {
                    logout();
                    closeNavbar(); // Ensure logout also closes navbar
                  }}
